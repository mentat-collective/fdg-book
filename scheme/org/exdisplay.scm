...
(define left-up-delimiter "\\begin{pmatrix} ")
(define right-up-delimiter "\\end{pmatrix}")

(define left-down-delimiter "\\begin{bmatrix} ")
(define right-down-delimiter "\\end{bmatrix}")
